            ...
            <div className="page-container">
                <div className="game-setup-container">
                    <div className="selection-row" style={{backgroundColor: '#DCF6E4'}}>
                        <Avatar size={{xs: 40, md: 100, lg: 100, xl: 100}} icon={RenderIcon(Avatar1, "Player 1 avatar")} style={{border: '10px solid #37AC5D'}}/>
                        <Input
                            label="Player 01"
                            className="player-text"
                            onChangeHandler={(e) => setPlayer1(e.target.value)}
                            properties={{ name: 'Player 01',
                                value: player1,
                                type: 'text',
                    ...
                    <div className="selection-row" style={{backgroundColor: '#F6EFD5'}}>
                        <Avatar size={{xs: 40, md: 100, lg: 100, xl: 100}} icon={RenderIcon(Avatar2, "Player 2 avatar")} style={{border: '10px solid #F8D146'}}/>
                        <Input
                            label="Player 02"
                            className="player-text"
                            onChangeHandler={(e) => setPlayer2(e.target.value)}
                            properties={{ name: 'Player 02',
                                value: player2,
                                type: 'text',
                    ...
                    <div className="selection-row" style={{backgroundColor: '#EFF3FF'}}>
                        <Avatar size={{xs: 40, md: 100, lg: 100, xl: 100}} icon={RenderIcon(NoOfGames, "number of games")} style={{border: '10px solid #B1C4F9', background: 'transparent'}}/>
                        <RadioSelect
                            label="Number of games"
                            className="radio-select-component"
                            selectedValue={noOfGames}
                            onRadioItemChange={(e)=>setGames(e)}
                            properties={{ name: 'Number of games',
                                value: player2,
                                type: 'text',
                                placeholder: 'Enter name for P2'
                            }}
                    ...
                    <div className="selection-row" style={{backgroundColor: '#EFF3FF'}}>
                        <Avatar size={{xs: 40, md: 100, lg: 100, xl: 100}} icon={RenderIcon(WhoStarts, "who starts")} style={{border: '10px solid #B1C4F9', background: 'transparent'}}/>
                        <RadioSelect
                            label="Who starts"
                            className="radio-select-component"
                            selectedValue={whoStarts}
                            onRadioItemChange={(e)=>setWhoStarts(e)}
                            properties={{ name: 'Who starts',
                                value: player2,
                                type: 'text',
